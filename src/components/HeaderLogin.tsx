...
export default function HeaderLogin({ toggleCard, card }: HeaderLoginProps) {
  ...
  const linkClasses = (link: string) =>
    `hover:text-blue-400 hover:scale-105 text-sm sm:text-md md:text-lg transition duration-300 ease-in-out font-bold ${
      card === link
  ...
  return (
    <header className="mt-3 h-12 w-full flex justify-between items-center max-w-3xl mx-auto p-2 fade-in">
